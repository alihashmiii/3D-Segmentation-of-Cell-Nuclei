...
ImageData[filledImage]
 ...
 Do[
imgData[[i]] = imgData[[i]]~fillholes ~fillh;
imgBinData[[i]] = imgBinData[[i]]~fillholes~fillh;
,{i,height}
]; 
...
(* ::Subsection:: *)
(*merge small nuclei with big neighbours*)
...
Options[segMergeNuclei]:= {"printseg"-> True,"printStats"->True,"mergeorder"-> 3,
"visualizeNuclei"-> True};
segMergeNuclei[file_,OptionsPattern[]]:= Module[{seg,segM,imgdata,masksM,boxesM,
iW,iH,iD,segNew},
seg=intialSeg[file];
...
segNew = QuantileNuclei[segM,imgdata,masksM,boxesM,iW,iH,iD];
